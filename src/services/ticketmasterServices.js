...
export async function getFestivals(ids) {
  try {
    const res = await fetch(
      `${BASE_URL}/v2/attractions?apikey=${API_KEY}&id=${ids}&locale=*`,
    );
    const data = await res.json();
    return data._embedded?.events || [];
  } catch (err) {
...
export async function getEvent(id) {
  try {
    const res = await fetch(
      `${BASE_URL}/v2/events/${id}?apikey=${API_KEY}&locale=*`,
    );
...
export async function getAttraction(id) {
  try {
    const res = await fetch(
      `${BASE_URL}/v2/attractions/${id}?apikey=${API_KEY}&locale=*`,
    );
    return await res.json();
  } catch (err) {
...
export async function getAttractionEvents(attractionId) {
  try {
    const res = await fetch(
      `${BASE_URL}/v2/events?apikey=${API_KEY}&attractionId=${attractionId}&locale=*`,
    );
    const data = await res.json();
    return data._embedded?.events || [];
  } catch (err) {
